...
subroutine solver_ac_forward_ram(rank,NumSou,NumRec,nxSou,nySou,nxRec,nyRec,&
S,dmodel,dt,ny,nx,ctmp,&
store_snap,nt_snap,nt,Fields,Rec_point)
...
implicit none
	...
	real, allocatable :: coef1(:),coef2(:)
        real :: Fields(ny,nx,nt_snap),TT_s(ny,nx)
...
!                        	op=op+1
!                        	do j=1,nyt
!                        		write(300+op,'(20000(e12.5,2x))') (p_3(j,i),i=1,nxt)
!                        	enddo
!
!                        endif
